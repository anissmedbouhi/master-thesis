### From https://github.com/BorgwardtLab/topological-autoencoders/blob/master/src/models/approx_based.py
...
class TopologicalLoss():
    ...
    """For the topologically regularized autoencoder."""

    def __init__(self, lambda_, toposig_kwargs=None):
    ...
    def compute(self, x, latent, latent_norm):
        ...
        topo_error = topo_error / x.shape[0]

        return self.lambda_ * topo_error
